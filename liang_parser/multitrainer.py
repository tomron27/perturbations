...
flags.DEFINE_integer("iter", 1, "number of passes over the whole training data", short_name="i") # changed 15 to 20
...
##            Perceptron.allweights = decoder.model.new_weights()
        Perceptron.c = 0 # int! # counter: how many neural_pos_tagger have i seen so far? = it * |train| + i
